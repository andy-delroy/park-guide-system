...
def run_recommendation_system():
    ...
    # Save the trained embeddings (guide and training)
    model.guide_model.save("guidetraining_embedding_model.keras")
    model.training_model.save("training_embedding_model.keras")

    print("Training completed and embedding models saved.")
