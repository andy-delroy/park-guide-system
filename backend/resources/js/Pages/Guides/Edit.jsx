...
const Edit = ({ auth, guide }) => {
    const { data, setData, put, processing, errors } = useForm({
        ...
        years_of_experience: guide.years_of_experience.toString(),
        ...
        >
            ...
            <SectionCard>
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        <label className="block mb-1 text-sm font-medium text-gray-700">Password (leave blank to keep unchanged)</label>
                        <input
                            type="password"
                            value={data.password}
                    ...
                    <div className="flex space-x-2">
                        <Button type="update" disabled={processing} typeAttr="submit">
                            {processing ? 'Updating...' : 'Update Guide'}
                        </Button>
                        <Link
                            href="/guides"
                        >
